    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-xs text-zinc-400">{host}</p>
          {snippet && (
        ...
        {index !== undefined && (
          <span className="ml-auto flex h-5 w-5 shrink-0 items-center justify-center rounded bg-zinc-100 text-[11px] font-medium text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400">
            {index}
          </span>
        )}
      </div>
