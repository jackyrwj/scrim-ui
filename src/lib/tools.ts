...
export type Tool = {
  ...
  description: string;
  /** One line. Used in the header search results and on the homepage cards. */
  tagline: string;
...
export const tools: Tool[] = [
  {
    ...
    tagline: "Design a custom AI model switcher and copy the React component",
    cta: "Open tool",
    status: "published",
    featured: true,
    isNew: true,
  },
  {
    ...
    tagline: "Compose a realistic AI chat screen and export as PNG",
    cta: "Open tool",
    status: "published",
    featured: true,
  },
  {
    ...
    tagline: "Generate a full AI chat color scheme from one brand color",
    cta: "Open tool",
    status: "published",
    featured: true,
  },
  ...
  },
  {
    ...
    tagline: "Place a screenshot in an iPhone, MacBook, iPad or browser frame",
    status: "published",
  },
  {
    slug: "flow-diagram",
  ...
  },
  {
    ...
    tagline: "Compose a realistic voice assistant screen and export as PNG",
    status: "published",
    featured: true,
  },
  {
    ...
    tagline: "Ready-made voice assistant transcripts for common scenarios",
    cta: "Browse scripts",
    status: "published",
  },
  {
    ...
    tagline: "Generate UI prompts for AI coding tools",
    status: "published",
  },
  {
    slug: "playground",
    ...
    tagline: "Interactive playground for all components",
    status: "published",
  },
];
